  ...
  implementation: async ({ url }, parameters, context, dependencies) => {
    ...
    try {
      await context.waitForSelector(
        'div[id*="popup-city-accept"] button[class*="popup__close icon-popup-close"]'
      );
      await context.click(
        'div[id*="popup-city-accept"] button[class*="popup__close icon-popup-close"]'
      );
    ...
    const captchaFrame =
      "iframe[_src*='captcha']:not([title]), iframe[src*='captcha']:not([title])";
    try {
    ...
    try {
      await context.click(
        'div[class*="search-flex-left"] button[class*=icon-search]'
      );

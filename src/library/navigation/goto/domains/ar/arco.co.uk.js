...
module.exports = {
  ...
  implementation: async (
    ...
    const captchaFrame = 'html>body>div[id="notfound"]';
    ...
    try {
      await context.click('div[class="captcha-state-handler"]');
    } catch (e) {
    ...
    const checkRedirection = async () => {
      try {
        await context.waitForSelector('div[class = "inner"] > img', { timeout });

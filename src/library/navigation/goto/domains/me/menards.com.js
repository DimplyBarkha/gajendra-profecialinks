...
module.exports = {
  ...
  implementation: async ({ url }, parameters, context, dependencies) => {
    ...
    const captchaFrame = 'iframe[_src*="https://www.google.com/recaptcha/api2/anchor?ar=1&k=6Ld38BkUAAAAAPATwit3FXvga1PI6iVTb6zgXw62&co=aHR0cHM6Ly93d3cubWVuYXJkcy5jb206NDQz&hl=en&v=-nejAZ5my6jV0Fbx9re8ChMK&size=normal&cb=isp06fim4s2i"]';
    const maxRetries = 3;

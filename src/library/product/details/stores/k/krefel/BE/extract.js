...
module.exports = {
  ...
  implementation: async ({ inputString }, { country, domain, transform }, context, { productDetails }) => {
    ...
    await context.waitForSelector('div.product-info span.current-price.orange.nl').catch(() => { console.log('price not available'); });
    const price = await context.evaluate(async function () {
      ...
      if (price) {
        document.querySelector('body').setAttribute('price', price);
      }
    ...
    console.log('priceeeeeeeeeeeeee', price);

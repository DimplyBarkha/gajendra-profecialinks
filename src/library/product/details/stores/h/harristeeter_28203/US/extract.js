...
module.exports = {
  ...
  implementation: async ({ inputString }, { country, domain, transform: transformParam }, context, { productDetails }) => {
    ...
    if (hasNutrition) {
      await context.goto(url + 'nutrition', { timeout: 10000000, waitUntil: 'load', checkBlocked: true });
    ...
    await context.evaluate(async function (nutritionDetails, IngredientDetails, DescriptionDetails, enhanceImage, enhanceContent) {
      ...
      // Nutrition
      if (nutritionDetails !== null && nutritionDetails.length > 0) {
        if (nutritionDetails[0] !== null && nutritionDetails[0] !== '') {
        ...
        if (nutritionDetails[5] !== null && nutritionDetails[5] !== '') {
        ...
        if (nutritionDetails[6] !== null && nutritionDetails[6] !== '') {
        ...
        if (nutritionDetails[7] !== null && nutritionDetails[7] !== '') {
        ...
        if (nutritionDetails[8] !== null && nutritionDetails[8] !== '') {
        ...
        if (nutritionDetails[9] !== null && nutritionDetails[9] !== '') {
        ...
        if (nutritionDetails[10] !== null && nutritionDetails[10] !== '') {
        ...
        if (nutritionDetails[11] !== null && nutritionDetails[11] !== '') {
        ...
        if (nutritionDetails[12] !== null && nutritionDetails[12] !== '') {
        ...
        if (nutritionDetails[13] !== null && nutritionDetails[13] !== '') {
        ...
        if (nutritionDetails[14] !== null && nutritionDetails[14] !== '') {
        ...
        if (nutritionDetails[15] !== null && nutritionDetails[15] !== '') {
        ...
        if (nutritionDetails[16] !== null && nutritionDetails[16] !== '') {

...
module.exports = {
  ...
  implementation: async (
    ...
    await context.evaluate(async function (zip) {
      ...
      if (zipInput) {
        const uri = `https://www.currys.co.uk/gb/uk/mcd_postcode_check/sProductId/${basicDetails.sku}/sPostCode/${zip}/latitude/51.508413/longitude/-0.106932/ajax.html`;
      ...
      const updatedRating = (actualRating * 5) / 10;
      ...
      smoothScroll('.shopList article.product');
    }, parameters.zipcode);

  ...
  implementation: async ({ inputString }, { country, domain, transform: transformParam }, context, { productDetails }) => {
    ...
    await context.evaluate(async function () {
      ...
      function preFetchProductDetails() {
        ...
        productInfo = productInfo && JSON.parse(productInfo.textContent);
        return productInfo;
      }
      ...
      if (document.querySelector('div[class="clipThumbnail"]') && document.querySelector('div[class="clipThumbnail"]') !== undefined) {

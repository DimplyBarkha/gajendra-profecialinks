...
module.exports = {
  ...
  implementation: async (
    ...
    await context.evaluate(async function () {
      ...
      const recentlyViewed = getAllXpath('//div[contains(@class,"site-recently-viewed")]//div[contains(@class,"item-name")]//a/text()', 'nodeValue');
    ...
    await context.evaluate(async function () {
      ...
      const getXpath = (xpath, prop) => {
        ...
        if (prop && elem && elem.singleNodeValue) {
          ...
          result = elem ? elem.singleNodeValue : '';
        }

  ...
  implementation: async (inputs,
    ...
    async function syndigoAPI2 (productID, pageId) {
      ...
      async function addECWidgets (productID, pageId) {
        ...
        const widgets = [...Object.values(Object.values(json.experiences)[0].experiences['power-page'].widgets), ...Object.values(Object.values(json.experiences)[0].experiences['hero'].widgets)];
      ...
      try {
        return await context.evaluate(addECWidgets, productID, pageId);
      } catch (error) {
        console.log('Error adding aplus widgets. Error: ', error);
      }
    }
    await syndigoAPI2(productID, pageId);

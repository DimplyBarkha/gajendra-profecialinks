...
const transform = (data) => {
  ...
  for (const { group } of data) {
    for (const row of group) {
      ...
      if (
        (!row.saltPerServing || !row.saltPerServing.length) &&
        row.saltPerServing1
      ) {
      ...
      if (
        (!row.totalFatPerServing || !row.totalFatPerServing.length) &&
        row.totalFatPerServing1
      ) {
      ...
      if (
        (!row.dietaryFibrePerServing || !row.dietaryFibrePerServing.length) &&
        row.dietaryFibrePerServing1
      ) {
      ...
      if (
        (!row.proteinPerServing || !row.proteinPerServing.length) &&
        row.proteinPerServing1
      ) {

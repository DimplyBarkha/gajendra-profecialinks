...
async function implementation (
  ...
  async function getVideoLinks () {
    const iframeSelector1 = 'div.videoContainer iframe';
    const iframeSelector2 = 'div[class *= "video-container"] iframe';

    const iframe = document.querySelector(iframeSelector1) || document.querySelector(iframeSelector2);
    if (!iframe) {

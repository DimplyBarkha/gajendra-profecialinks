...
module.exports = {
  ...
  implementation: async (inputs,
    ...
    const isStorePresent = await context.evaluate(async function () {
      ...
      // @ts-ignore
      return isStorePresent ? !!isStorePresent.innerText.trim().includes('Wicker Park Lowe') : false;
    });
    try {
      ...
      if (!isStorePresent) {
        ...
        await context.evaluate(async function () {
          ...
          inputElement && inputElement.setAttribute('value', "Wicker Park Lowe's 1360");
        });
        await context.waitForSelector('input[value*="Wicker Park Lowe"]');
        await context.evaluate(async function () {

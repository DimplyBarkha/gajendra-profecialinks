...
module.exports = {
  ...
  parameterValues: {
    ...
    noResultsXPath: '//div[@class="notfound-content"] | //div[contains(@class,"search-empty")] | //div[@class="left-sidebar"]',
    // noResultsXPath: '//div[contains(@class,"search-empty")] | //div[@class="left-sidebar"]',
    zipcode: '',
  },
};

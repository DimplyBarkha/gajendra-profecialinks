module.exports = {
  ...
  parameterValues: {
    ...
    noResultsXPath: '//div[contains(@class,"message info empty")]',
    zipcode: '',
  },
  implementation: async (inputs, { loadedSelector, noResultsXPath }, context, dependencies) => {
    ...
    if (id) {
      ...
      let newUrl = await context.evaluate(() => document.querySelector('li[class="item product product-item"] a:nth-child(2)').getAttribute('href'));

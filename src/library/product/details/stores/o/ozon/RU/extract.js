  ...
  implementation: async (inputs, parameters, context, dependencies) => {
    ...
    await context.evaluate(async () => {
      ...
      dataStateDivs.forEach((dataStateDiv) => {
        ...
        if (dataStateDiv.id.includes('state-webGallery')) {
          ...
          if (dataMediaObj.images) {
            ...
            addElementToDocument('oz-add-img-total', dataMediaObj.images.length - 1);
          }
        }
      });
      ...
      if (jsonDiv) {
        ...
        if (jsonData.offers.availability && jsonData.offers.availability.includes('InStock')) {
        ...
        ingridientsElem.forEach((item) => {
          ...
          function findNutrition (itemNode, name, elemValId, elemTextId) {
            ...
            if (itemTitle.includes(name)) {
              ...
              addElementToDocument(elemTextId, 'г');
            }
          }

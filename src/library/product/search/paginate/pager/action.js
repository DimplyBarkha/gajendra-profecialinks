...
async function implementation (
  ...
  if (spinnerSelector) {
    ...
    }, { timeout: 150000 }, spinnerSelector);
  ...
  if (mutationSelector) {
    ...
    await Promise.all([
      ...
      context.waitForMutuation(mutationSelector, { timeout: 150000 }),
    ]);
    return true;
  }
  ...
  if (nextLinkSelector) {
    ...
    await context.clickAndWaitForNavigation(nextLinkSelector, {}, { timeout: 150000 });
    if (loadedSelector) {
      await context.waitForSelector(loadedSelector, { timeout: 150000 });
    }
    return true;
  }
  return false;

module.exports = {
  ...
  implementation: async ({ keywords, Keywords, Brands, results = 150, url, URL }, { country, store, domain, zipcode }, context, { execute, extract, paginate }) => {
    ...
    const resultsReturned = await execute({ keywords, zipcode, url, URL });

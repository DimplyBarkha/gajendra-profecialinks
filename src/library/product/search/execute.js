/**
 *
 * @param { { keywords: string, url: string, zipcode: string } } inputs
...
async function implementation (
  ...
  const url = inputs.keywords ? parameters.url.replace('{searchTerms}', encodeURIComponent(inputs.keywords)) : inputs.url;

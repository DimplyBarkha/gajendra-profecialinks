  ...
  implementation: async (inputs, parameters, context, dependencies) => {
    ...
    await context.evaluate(async () => {
      ...
      function fetchPage (pageNum, code, authToken) {
        ...
        return fetch(
          `https://api.shipt.com/search/v3/search/?bucket_number=86&white_label_key=shipt&segway_version=${code}`,
          {
            headers: {
              accept: '*/*',
            ...
            body:
              `{"user_id":15735829,"store_id":27,"metro_id":116,"store_location_id":3475,"query":"${keyword}","zip":"55449","facets":["on_sale","active_deals","brand_name","categories","h1categories","h2categories"],"page":${pageNum},"include_visual_facets":true,"featured":true,"section_id":1}`,
            method: 'POST',
            mode: 'cors',
            credentials: 'include',
          },

...
async function implementation(
  ...
  await context.evaluate(async function () {
    ...
    function addHiddenDiv(id, content, index) {
      ...
      const originalDiv = document.querySelectorAll('li[class="item"]')[index];
    ...
    try {
      if (checkPageNumber.startsWith('f=')) {
        rankOrganic = checkPageNumber.replace('f=', '');
      }
    }
    catch (err) {
    }
    ...
    const urlProduct = document.querySelectorAll('li[class="item"]');

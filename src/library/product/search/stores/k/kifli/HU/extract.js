...
const implementation = async function (
  ...
  async function getProductsCount (context) {
    return context.evaluate(async function () {
      const products = document.evaluate("//div[@class='productCard__imageWrapper']/img/@src", document.body, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
      //console.log("prodcuts snapshotlength ::"+products.snapshotLength)

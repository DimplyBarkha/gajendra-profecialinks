...
async function implementation(
  ...
  await context.evaluate(async function () {
    ...
    function addHiddenDiv(id, content, index) {
      ...
      const originalDiv = document.querySelectorAll('div[class="ooB-mb12 ooB-mt6 artikelnummer"]')[index];
    ...
    const urlProduct = document.querySelectorAll('div[class="ooB-mb12 ooB-mt6 artikelnummer"]');

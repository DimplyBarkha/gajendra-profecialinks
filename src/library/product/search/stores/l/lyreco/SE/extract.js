...
const originalDiv = document.querySelectorAll('div[class="col d-flex product2comp pt-1 px-0 grid__item border "]')[index];
...
const urlProduct = document.querySelectorAll('div[class="col d-flex product2comp pt-1 px-0 grid__item border "]');

...
//         });
//       }
//       let products = document.evaluate('//img[@class="responsive-image responsive-image--"]/@src', document.body, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
//       let productsCount = products.snapshotLength;
//       const seeAllSelector = document.querySelector('div[class="load-more-button"] > button');
//       while (productsCount <= 150) {
//         console.log('Length: ' + productsCount);
//         if (seeAllSelector !== null) {
//           seeAllSelector.click();
//           await stall(1000);
//           products = document.evaluate('//img[@class="responsive-image responsive-image--"]/@src', document.body, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);

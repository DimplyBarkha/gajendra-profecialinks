...
module.exports = {
  ...
  parameterValues: {
    ...
    url: 'https://douglas.es/?q={searchTerms}&page=42',
    loadedSelector: 'data-eb-results[id="eb-results"] data-eb-result',
    noResultsXPath: '//p[@data-translate="RESULTS_NORESULTS"] | //p[@data-translate="RESULTS_PARTIALS_NO_RESULTS" and @class="eb-no-results-suggestions ng-scope"]',
    zipcode: '',
  },
};

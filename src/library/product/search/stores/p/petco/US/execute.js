...
//         const products = document.evaluate('//div[contains(@class,"product-image")]//img/@src', document.body, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
...
//         });
//       }
//       let products = document.evaluate('//div[contains(@class,"product-image")]//img/@src', document.body, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
//       let productsCount = products.snapshotLength;
//       const seeAllSelector = document.querySelector('.pagination > li:last-child > a');
//       while (productsCount <= 150) {
//         console.log('Length: ' + productsCount);
//         if (seeAllSelector !== null) {
//           seeAllSelector.click();
//           await stall(1000);
//           products = document.evaluate('//div[contains(@class,"product-image")]//img/@src', document.body, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
...
//     domain: 'petco.us',
//     url: 'https://www.petco.com/shop/SearchDisplay?categoryId=&storeId=10151&catalogId=10051&langId=-1&sType=SimpleSearch&resultCatEntryType=2&showResultsPage=true&searchSource=Q&pageView=&beginIndex=0&pageSize=150&fromPageValue=search&searchKeyword=&searchTerm={searchTerms}',
//     loadedSelector: 'div[class="product-image"]',

...
module.exports = {
  ...
  parameterValues: {
    ...
    openSearchDefinition: {
      pageStartNb: 0,
      template: 'https://www.mondoffice.com/INTERSHOP/web/WFS/RAJA-MONDOFFICE-Site/it_IT/-/EUR/ViewParametricSearch-ProductPaging?PageNumber={page}&PageSize=150&SortingAttribute=&ViewType=1&SearchTerm={searchTerms}',
    },

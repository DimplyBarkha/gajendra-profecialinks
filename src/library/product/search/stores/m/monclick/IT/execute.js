...
module.exports = {
  ...
  parameterValues: {
    ...
    store: 'monclick',
    domain: 'monclick.it',
    url: 'https://www.monclick.it/risultati_ricerca?fh_view_size=10&fh_sort_by=-orderby_piupopolari,-_match_rate&fh_location=//root/it_IT/$s={searchTerms}&testo={searchTerms}',

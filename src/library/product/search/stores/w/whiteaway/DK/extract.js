...
async function implementation(
  ...
  await context.evaluate(async function () {
    ...
    function addHiddenDiv(id, content, index) {
      ...
      const originalDiv = document.querySelectorAll('div[class="srp-product-box-outer list"]')[index];
    ...
    try {
      if (checkPageNumber.startsWith('counter=')) {
        rankOrganic = checkPageNumber.replace('counter=', '');
      }
    }
    catch (err) {
    }
    ...
    const urlProduct = document.querySelectorAll('div[class="srp-product-box-outer list"]');

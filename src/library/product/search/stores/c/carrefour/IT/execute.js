...
//       let scrollTop = 0;
//       while (scrollTop !== 20000) {
//         const products = document.evaluate('//div[contains(@class,"image-container")]//img/@src', document.body, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
...
//         });
//       }
//       let products = document.evaluate('//div[contains(@class,"image-container")]//img/@src', document.body, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
//       let productsCount = products.snapshotLength;
//       const seeAllSelector = document.querySelector('');
//       while (productsCount <= 150) {
//         console.log('Length: ' + productsCount);
//         if (seeAllSelector !== null) {
//           seeAllSelector.click();
//           await stall(1000);
//           products = document.evaluate('//div[contains(@class,"image-container")]//img/@src', document.body, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
...
//     loadedSelector: 'div[class="image-container"]',
//     noResultsXPath: '//div[contains(@class,"main-container")]//h1',
//     zipcode: '',
//   },
//   implementation,
// };

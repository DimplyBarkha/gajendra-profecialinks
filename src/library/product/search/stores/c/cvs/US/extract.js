...
async function implementation(
  ...
  await context.evaluate(async function (results, keywords) {
    ...
    if (document.querySelector('.load-more.gb-ui button')) {
      ...
      var jsonText = await fetch('https://www.cvs.com/shop-assets/proxy/search?query='+keywords+'&skip='+offset+'&pageSize=50&fields=%5B%22*%22%2C%22id%22%5D&orFields=%5B%22variants.subVariant.availability%22%5D&refinements=%5B%5D').then(res =>
      res.text()
    );

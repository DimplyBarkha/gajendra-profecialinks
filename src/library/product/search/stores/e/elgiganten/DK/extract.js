...
async function implementation(
  ...
  while (scrollTop !== 1000000) { // TODO: need to update it for a selector for end of page
    if (recordsOnPage < maxRecords) {
      ...
      console.log('recordssss', recordsOnPage);
      //if(recordsOnPage == recordsCollected) return -1;
    } else {
      break;
    }
    if (scrollTop === 1000000) { // TODO: need to update it for a selector for end of page
      break;
    }
  }
